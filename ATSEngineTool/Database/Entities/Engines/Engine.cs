...
{
    /// <summary>
    /// Defines an engine that powers a <see cref="Truck"/>
    /// </summary>
    ...
    public class Engine
    {
        ...
        /// <summary>
        /// Gets or Sets the resistive torque in N·m at 2000rpm, 
        /// used for passive engine braking and consumption.
        /// </summary>
        /// <remarks>
        /// New as of ETS 1.27/ATS 1.6
        /// </remarks>
        [Column, Required, Default(-1)]
        public int ResistanceTorque { get; set; } = -1;
        ...
        /// the engine brake is applied, within rpm_range_engine_brake
        /// </summary>
        [Column, Required, Default(true)]
        public bool BrakeDownshift { get; set; } = true;
        ...
        /// <summary>
        /// Gets or Sets the fuel consumption scale of the engine relative to the game's 
        /// calculated value.
        /// </summary>
        [Column, Required, Default("1.0", Quote = false)]
        public decimal FuelConsumption { get; set; } = 1.0m;

        /// <summary>
        /// Gets or Sets how many liters of AdBlue (Diesel Exhaust Fluid) are consumed per liter of fuel.
        /// </summary>
        /// <remarks>
        /// For older engines which do not use AdBlue, this attribute should be set to 0.
        /// </remarks>
        [Column, Required, Default(0)]
        public decimal AdblueConsumption { get; set; } = 0.00m;

        /// <summary>
        /// Gets or Sets the engine's power scale when the AdBlue tank is empty.
        /// </summary>
        [Column, Required, Default(0)]
        ...
        protected string _defaults { get; set; } = String.Empty;

        [Column("Overrides"), Default("")]
        protected string _overrides { get; set; } = String.Empty;

        [Column("Comment"), Default("")]
        protected string _comment { get; set; } = String.Empty;

        [Column("Conflicts"), Default("")]
        protected string _conflicts { get; set; } = String.Empty;

        [Column("SuitableFor"), Default("")]
        protected string _suitables { get; set; } = String.Empty;
        ...
        /// <summary>
        /// Contains an array of Overrides for the truck to load
        /// </summary>
